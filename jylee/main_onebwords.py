...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_img_num', default=0, type=int, help='must be less than or equal to target_count')
    ...
    parser.add_argument('--max_input_len', default=4096, type=int, choices=[256, 1024, 4096, 8192])
    ...
    train_ds = OneBillionWordsDataset(args.max_input_len, train_type='train')
    ...
    if not args.transformer:
        model = PerformerLightning_OneBillionWords(
            lr=args.lr,
        ...
        model = TransformerLightning_OneBillionWords(
            lr=args.lr,
            weight_decay=args.weight_decay,
            # tokenizer=tokenizer,
            # pad_token_idx=tokenizer.token_to_id("[PAD]"),
