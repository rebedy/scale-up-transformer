...
class Net2NetTransformer(pl.LightningModule):
    def __init__(self, transformer_config, first_stage_config,
        ...
        if permuter_config is None:
            permuter_config = {"target": "taming.modules.transformer_pytorch.permuter.Identity"}
    ...
    def sample(self, x, c, steps, temperature=1.0, sample=False, top_k=None,
        ...
        if self.pkeep <= 0.0:
            ...
            #noise = torch.randint(self.transformer_pytorch.config.vocab_size, noise_shape).to(x)
