...
from loader_unified import UnifiedCXRDataset2
from datamodule import CXRDataModule
from unified_plmodel import TransformerLightning_unified2

"""

CUDA_VISIBLE_DEVICES=4,5 python3 unified2_main.py --vqgan 512 --transformer --target_count 2 --max_img_num 1
CUDA_VISIBLE_DEVICES=6,7 python3 unified2_main.py --vqgan 512 --transformer --target_count 2 --max_img_num 2
CUDA_VISIBLE_DEVICES=4,5 python3 unified2_main.py --vqgan 512 --transformer --FAVOR --generalized_attention --attn_type conditioned_cuda --target_count 2 --max_img_num 2
CUDA_VISIBLE_DEVICES=6,7 python3 unified2_main.py --vqgan 512 --transformer --FAVOR --generalized_attention --attn_type conditioned_cuda --target_count 2 --max_img_num 2 --test
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reload_ckpt_dir', default="/home/edlab/dylee/scaleup_transformer/unified_Performers/unified2_sut_conditioned_causal_2of2_20220412_22h09m_d256_l4_h4_conditioned_cuda_res512_trans_gen/epoch=33-step=39643.ckpt", type=str)
    ...
    args.num_img_tokens = train_ds.img_vocab_size + \
        train_ds.max_img_num  # NOTE: img vocab size + num img pad  1024
    ...
    folder_path = "unified2_sut_" + str(args.causal_clm) + "_" + str(args.max_img_num) + "of" + str(args.target_count) + "_" + TODAY + NOW +\
    ...
    model = TransformerLightning_unified2(
        lr=args.lr,
    ...
    args.wandb_name = NOW
    wandb_logger = WandbLogger(entity='sut', project='unified2_Performer_' + TODAY, name=args.wandb_name, log_model=True, config=args)
