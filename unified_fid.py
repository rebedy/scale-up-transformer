...
def preprocess_images(images, use_multiprocessing):
    ...
    if use_multiprocessing:
        ...
        final_images = torch.stack([preprocess_image(im)
                                   for im in images], dim=0)
...
if __name__ == "__main__":
    ...
    # 이미지 분리##
    # img_path = '/home/edlab/dylee/scaleup_transformer/t2i_Performers/t2i_conditioned_causal_1of1_20220215_06h19m_d256_l4_h4_conditioned_cuda_res512_lr_0.001_trans_gen/'
    img_path = '/home/edlab/dylee/scaleup_transformer/unified_Performers/unified_sut_conditioned_causal_2of2_20220326_10h44m_d256_l4_h4_conditioned_cuda_res512_trans_gen/decoded_images/'
    file_list = os.listdir(img_path)

    gen_img_list = glob.glob(img_path + '*_gen*')
    gt_img_list = glob.glob(img_path + '*_GT*')
    print(gen_img_list)
    # print(gt_img_list)
    for file in gen_img_list:
        img = Image.open(file)
        # img = img.convert("RGB")
        img.save('/home/edlab/dylee/scaleup_transformer/t2i_Performers/gen_img/' + os.path.split(file)[1], 'jpeg')
    for file_2 in gt_img_list:
        img_2 = Image.open(file_2)
        # img_2 = img_2.comvert("RGB")
        img_2.save('/home/edlab/dylee/scaleup_transformer/t2i_Performers/gt_img/' + os.path.split(file_2)[1], 'jpeg')

    # print(os.listdir('/home/edlab/dylee/scaleup_transformer/t2i_Performers/gen_img/'))
    images1 = load_images(gen_img_list)
    images2 = load_images(gt_img_list)
    batch_size = 8
    fid_value = calculate_fid(
        images1, images2, options.use_multiprocessing, batch_size)
    '''
