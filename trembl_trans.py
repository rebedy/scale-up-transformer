...
#!#  
"""
CUDA_VISIBLE_DEVICES=2 python3 -m torch.distributed.launch --nproc_per_node=1 trembl_trans.py --mpi_port 12514
"""
...
def main_worker(args: argparse.Namespace):
    ...
    if gpu == 0:
        ...
        ## Make DIRs
        exp_name = f"sut_trans_{TODAY}{NOW}_txt{args.max_seq_len}_h{args.heads}_l{args.depth}_dff{args.d_ff}_d{args.dim}_bz{args.batch_size}"
