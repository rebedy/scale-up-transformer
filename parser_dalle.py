...
parser.add_argument('--attn_types', default='conditioned_i2t', type=str, choices=['conditioned_i2t','full','sparse','axial_row','axial_col','conv_like','mlp',],
...
parser.add_argument('--save_dir_base', default="/home/edlab/dylee/scaleup_transformer/transformer_dalle/" ,type=str)
