...
def main_worker(args: argparse.Namespace):
    ...
    if gpu == 0:
        ...
        ## Make DIRs
        exp_name = f"sut_{TODAY}{NOW}_favor_{args.kernel_type}_txt{args.max_seq_len}_h{args.heads}_l{args.depth}_dff{args.d_ff}_d{args.dim}_bz{args.batch_size}"
    ...
    print("\nStart Training.. Performer ", args.kernel_type)
