...
parser.add_argument('--task', default='train_mini', choices=['val', 'test','train_mini','train'], type=str)
...
#######!########
                #"/home/edlab/dylee/scaleup_transformer//"
# args.infer_ckpt= args.save_dir_base+"/epoch=000004.ckpt"
args.infer_ckpt= "/home/edlab/dylee/scaleup_transformer/transformer_q256/sut_q256_20211012_01h50m_totim1_im1_txt256_fixed_bz20_ep50_lr5e-05_relu/epoch=000009.ckpt"
#######!########
...
for epoch in range(args.start_epoch, args.start_epoch+1):
    ...
    chencherries = [SmoothingFunction().method1, SmoothingFunction().method2, SmoothingFunction().method4, SmoothingFunction().method5, SmoothingFunction().method6, SmoothingFunction().method7]
