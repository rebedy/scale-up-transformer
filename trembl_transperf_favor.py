...
#!#  
"""
CUDA_VISIBLE_DEVICES=3 python3 -m torch.distributed.launch --nproc_per_node=1 trembl_transperf_favor.py --kernel_type favor --mpi_port 12513
"""
...
def main_worker(args: argparse.Namespace):
    ...
    if gpu == 0:
        ...
        ## Make DIRs
        exp_name = f"sut_transperf_favor_{TODAY}{NOW}_txt{args.max_seq_len}_h{args.heads}_l{args.depth}_dff{args.d_ff}_d{args.dim}_bz{args.batch_size}"
    ...
    print("\nStart Training.. Transformer+Performer Favor", args.kernel_type)
