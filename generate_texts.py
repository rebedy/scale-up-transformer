...
parser.add_argument('--reload_ckpt_dir', default='/home/edlab/wcshin/performer_cxr_i2t/i2t_base/checkpoints/epoch=000004.ckpt', type=str)
...
parser.add_argument('--batch_size', default=4, type=int)   ### 8로 바꾸기
