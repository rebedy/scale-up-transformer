...
#!#  
""" 
CUDA_VISIBLE_DEVICES=4,5 python -m torch.distributed.launch --nproc_per_node=2 c256_main_dalle.py
"""
...
import c512_parser_dalle as parser_
...
def main_worker(args: argparse.Namespace):
    ...
    if gpu == 0:
        ...
        # test_dl  109
        print("\n")        
        print(" >>> Transformer CNN 512 version!!!!!")
        ...
        ## Make DIRs
        exp_name = f"sut_c512_{TODAY}{NOW}_totim{args.target_count}_im{args.max_img_num}_txt{args.max_text_len}_{args.under_sample_type}_bz{args.batch_size}_ep{args.epochs}_lr{args.lr}_{args.activation}"
