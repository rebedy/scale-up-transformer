...
parser.add_argument('--heads', default=12, type=int, help='Model number of heads. Attention heads.')
                        #!#
parser.add_argument('--dim_head', default=16, type=int, help='Model head dimension. dim of head. inner_dim = dim_head * heads') 
...
parser.add_argument('--save_dir_base', default="/home/edlab/dylee/scaleup_transformer/transformer_q256/" ,type=str)
