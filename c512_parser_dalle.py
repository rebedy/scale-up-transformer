...
parser.add_argument('--img_resol', default=512, type=int) # image albumentation preprocessing
...
parser.add_argument('--save_dir_base', default="/home/edlab/dylee/scaleup_transformer/transformer_c512/" ,type=str)
