...
def get_label_metric_v4(hypothesis, reference):
    ...
    return (accuracy_pos1, precision_pos1, recall_pos1, f1_pos1), \
        (accuracy_0, precision_0, recall_0, f1_0), \
        (accuracy_neg1, precision_neg1, recall_neg1, f1_neg1), \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp_file', type=str, default='/home/dylee/scaleup_transformer/chexpert-labeler/labeled_GEN_epoch=000008_best_val_bleu_0.299_0.178_0.113_0.078_top_p_thres_0.9_tempr_0.7.csv',
                        help='chexpert labeler output csv file of GEN text')

    parser.add_argument('--ref_file', type=str, default='/home/dylee/scaleup_transformer/chexpert-labeler/labeled_GT_epoch=000008_best_val_bleu_0.299_0.178_0.113_0.078_top_p_thres_0.9_tempr_0.7.csv',
