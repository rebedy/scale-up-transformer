...
# ## mdvl
# parser.add_argument('--train_meta_file', default='metadata/mdvl_Train.jsonl', type=str)
# parser.add_argument('--val_meta_file', default='metadata/mdvl_Valid.jsonl', type=str)
# parser.add_argument('--test_meta_file', default='metadata/mdvl_testing.jsonl', type=str)
# parser.add_argument('--img_root_dir', default='/home/data_storage/dylee_135/mimic-mdvl-preprocessed/re_512_3ch', type=str)
# #!#


## quantization
parser.add_argument('--train_mini_meta_file', default='metadata/mdvl_mimiccxr_train_mini.csv', type=str)
...
parser.add_argument('--img_root_dir', default='/home/data_storage/mimic-cxr/dataset/original_mimic_jpg/files', type=str)
...
if IMG_SIZE == 256:
    ...
    parser.add_argument('--vqgan_config_path', default='metadata/2021-10-10_512-project.yaml', type=str)
else:
    raise ValueError
...
parser.add_argument('--heads', default=12, type=int, help='Model number of heads. Attention heads.')
                        #!#
parser.add_argument('--dim_head', default=16, type=int, help='Model head dimension. dim of head. inner_dim = dim_head * heads') # projection matrix에 의해 head별 차원수: dim_head -> nb_fetures
...
parser.add_argument('--reversible', default=False, type=str2bool, help='reversible layers, from Reformer paper. Works only when sharded_ddp=True')
                        #!#
parser.add_argument('--attn_types', default='favor+', type=str, choices=['conditioned_i2t', 'favor+', 'full','sparse','axial_row','axial_col','conv_like','mlp',],
...
parser.add_argument('--sparse_attn', default=False, type=str2bool, help='')
...
parser.add_argument('--save_dir_base', default="/home/edlab/dylee/scaleup_transformer/performers_q256/" ,type=str)
