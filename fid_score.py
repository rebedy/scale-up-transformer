...
if __name__ == "__main__":
    ...
    # ##이미지 분리##
    img_path = '/home/edlab/dylee/scaleup_transformer/t2i_Performers/t2i_conditioned_causal_1of1_20220321_22h02m_d256_l4_h4_conditioned_cuda_res512_lr_0.001_trans_gen/decoded_images/'
    file_list = os.listdir(img_path)
    # print(file_list)
    gen_img_list = glob.glob(img_path + '*_gen*')
    gt_img_list = glob.glob(img_path + '*_GT*')
    print(len(gen_img_list))
    ...
    images1 = load_images('/home/edlab/dylee/scaleup_transformer/t2i_Performers/gen_img')
    images2 = load_images('/home/edlab/dylee/scaleup_transformer/t2i_Performers/gt_img')
    batch_size = 8
    fid_value = calculate_fid(images1, images2, options.use_multiprocessing, batch_size)
    '''
